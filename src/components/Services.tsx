    ...
    },
    {
        ...
        icon: (
            <svg width="36" height="36" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.2">
                ...
                <rect x="10" y="24" width="28" height="2" rx="1" />
                <rect x="10" y="30" width="20" height="2" rx="1" />
            </svg>
        ),
                ...
                {services.map((service, i) => (
                    <div
                        ...
                        style={{
                            ...
                            transition: `opacity 0.6s ease ${i * 0.12}s, transform 0.6s ease ${i * 0.12}s, box-shadow 0.3s ease, background 0.3s ease`,
                            cursor: "default",
                        }}
                        onMouseEnter={e => {
                            e.currentTarget.style.boxShadow = `0 20px 60px ${service.accent}22`;
                            e.currentTarget.style.background = service.color.replace("0.1", "0.18");
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                boxShadow: `0 4px 16px ${service.accent}22`,
                            }}>
                            ...
                            <span style={{
                                ...
                                color: `${service.accent}22`, lineHeight: 1,
                            }}>
                                {service.number}
                            </span>
                        </div>
                        ...
                        <h3 style={{
                            ...
                            color: "#1d1d1f", marginBottom: 16, lineHeight: 1.2,
                        }}>
                            {service.title}
                        </h3>
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                            {service.tags.map((tag) => (
                                <span key={tag} style={{
                                    fontSize: 12, color: service.accent,
                                    background: "rgba(255,255,255,0.7)",
